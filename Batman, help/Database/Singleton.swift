...
class Singleton: DatabaseAccess {
    ...
    private init() {
        ...
        var character = Character(id: 60, name: "Bane", type: .villain, assetName: "characters-bane", powerstats: powerstats, height: 203, weight: 180, baseLocation: "Santa Prisca", occupation: nil)
        characters.append(character)
        
        powerstats = CharacterPowerstats(intelligence: 88, strengh: 11, speed: 33, durability: 40, power: 34, combat: 90)
        character = Character(id: 60, name: "Batgirl", type: .hero, assetName: "characters-batgirl", powerstats: powerstats, fullName: "Barbara Gordon", height: 170, weight: 57, baseLocation: "Gotham City", occupation: nil)
        characters.append(character)
        
        powerstats = CharacterPowerstats(intelligence: 100, strengh: 26, speed: 27, durability: 50, power: 47, combat: 100)
        character = Character(id: 70, name: "Batman", type: .hero, assetName: "characters-batman", powerstats: powerstats, fullName: "Bruce Wayne", height: 188, weight: 95, baseLocation: "Gotham City", occupation: "Businessman")
        characters.append(character)
        
        powerstats = CharacterPowerstats(intelligence: 69, strengh: 11, speed: 33, durability: 28, power: 27, combat: 85)
        character = Character(id: 165, name: "Catwoman", type: .hero, assetName: "characters-catwoman", powerstats: powerstats, fullName: "Selina Kyle", height: 175, weight: 61, baseLocation: "Gotham City", occupation: "Thief")
        characters.append(character)
        
        powerstats = CharacterPowerstats(intelligence: 88, strengh: 12, speed: 33, durability: 65, power: 55, combat: 80)
        character = Character(id: 309, name: "Harley Quinn", type: .villain, assetName: "characters-harley-quinn", powerstats: powerstats, fullName: "Harley Quinn", height: 170, weight: 63, baseLocation: "Arkham Asylum", occupation: "Psychiatrist")
        characters.append(character)
        
        powerstats = CharacterPowerstats(intelligence: 100, strengh: 10, speed: 12, durability: 60, power: 43, combat: 70)
        character = Character(id: 370, name: "Joker", type: .villain, assetName: "characters-joker", powerstats: powerstats, fullName: "Jack Napier", height: 196, weight: 86, baseLocation: "Arkham Asylum", occupation: nil)
        characters.append(character)
        
        powerstats = CharacterPowerstats(intelligence: 88, strengh: 11, speed: 33, durability: 28, power: 36, combat: 100)
        character = Character(id: 491, name: "Nightwing", type: .hero, assetName: "characters-nightwing", powerstats: powerstats, fullName: "Dick Grayson", height: 178, weight: 79, baseLocation: "Bludhaven", occupation: "Detective")
        characters.append(character)
        
        powerstats = CharacterPowerstats(intelligence: 75, strengh: 10, speed: 12, durability: 28, power: 30, combat: 45)
        character = Character(id: 514, name: "Penguin", type: .villain, assetName: "characters-penguin", powerstats: powerstats, fullName: "Oswald Chesterfield Cobblepot", height: 157, weight: 79, baseLocation: "Gotham City", occupation: "Trader")
        characters.append(character)
        
        powerstats = CharacterPowerstats(intelligence: 81, strengh: 14, speed: 21, durability: 40, power: 100, combat: 40)
        character = Character(id: 522, name: "Poison Ivy", type: .villain, assetName: "characters-poison-ivy", powerstats: powerstats, fullName: "Pamela Isley", height: 168, weight: 50, baseLocation: "Gotham City", occupation: "Botanist")
        characters.append(character)
        
        powerstats = CharacterPowerstats(intelligence: 100, strengh: 10, speed: 12, durability: 14, power: 10, combat: 14)
        character = Character(id: 558, name: "Riddler", type: .villain, assetName: "characters-riddler", powerstats: powerstats, fullName: "Edward Nigma", height: 183, weight: 83, baseLocation: "Gotham City", occupation: nil)
        characters.append(character)
